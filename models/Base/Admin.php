...
abstract class Admin implements ActiveRecordInterface
{
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[AdminTableMap::COL_NAME] = true;
        }
    ...
    public function setEmailaddress($v)
    {
        ...
        if ($this->emailaddress !== $v) {
            $this->emailaddress = $v;
            $this->modifiedColumns[AdminTableMap::COL_EMAILADDRESS] = true;
        }
    ...
    public function setPasswordhash($v)
    {
        ...
        if ($this->passwordhash !== $v) {
            $this->passwordhash = $v;
            $this->modifiedColumns[AdminTableMap::COL_PASSWORDHASH] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AdminTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : AdminTableMap::translateFieldName('Emailaddress', TableMap::TYPE_PHPNAME, $indexType)];
            $this->emailaddress = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : AdminTableMap::translateFieldName('Passwordhash', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(AdminTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(AdminTableMap::COL_EMAILADDRESS)) {
            $modifiedColumns[':p' . $index++]  = 'emailAddress';
        }
        if ($this->isColumnModified(AdminTableMap::COL_PASSWORDHASH)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AdminTableMap::COL_NAME)) {
            $criteria->add(AdminTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(AdminTableMap::COL_EMAILADDRESS)) {
            $criteria->add(AdminTableMap::COL_EMAILADDRESS, $this->emailaddress);
        }
        if ($this->isColumnModified(AdminTableMap::COL_PASSWORDHASH)) {
            $criteria->add(AdminTableMap::COL_PASSWORDHASH, $this->passwordhash);
        }
