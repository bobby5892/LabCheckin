 ...
 */
abstract class LabVisit implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\LabVisitTableMap';
    ...
    /**
     * The value for the checkout field.
     *
     * @var        DateTime
     */
    protected $checkout;
    ...
    /**
     * Compares this with another <code>LabVisit</code> instance.  If
     * <code>obj</code> is an instance of <code>LabVisit</code>, delegates to
     * <code>equals(LabVisit)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|LabVisit The current object, for fluid interface
     */
     ...
     */
    public function getCheckin($format = NULL)
    {
        if ($format === null) {
            return $this->checkin;
        } else {
            return $this->checkin instanceof \DateTimeInterface ? $this->checkin->format($format) : null;
        }
    }

    /**
     * Get the [optionally formatted] temporal [checkout] column value.
     *
     *
     * @param      string|null $format The date/time format string (either date()-style or strftime()-style).
     *                            If format is NULL, then the raw DateTime object will be returned.
     ...
     * @throws PropelException - if unable to parse/validate the date/time value.
     */
    public function getCheckout($format = NULL)
    {
        if ($format === null) {
            return $this->checkout;
        } else {
            return $this->checkout instanceof \DateTimeInterface ? $this->checkout->format($format) : null;
        }
    }

    /**
     * Get the [courseid] column value.
     *
     * @return int
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[LabVisitTableMap::COL_ID] = true;
        }
    ...
    public function setCheckin($v)
    {
        ...
        if ($this->checkin !== null || $dt !== null) {
            if ($this->checkin === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->checkin->format("Y-m-d H:i:s.u")) {
                $this->checkin = $dt === null ? null : clone $dt;
                $this->modifiedColumns[LabVisitTableMap::COL_CHECKIN] = true;
            }
    ...
    /**
     * Sets the value of [checkout] column to a normalized version of the date/time value specified.
     *
     * @param  mixed $v string, integer (timestamp), or \DateTimeInterface value.
     *               Empty strings are treated as NULL.
     * @return $this|\LabVisit The current object (for fluent API support)
    ...
    {
        $dt = PropelDateTime::newInstance($v, null, 'DateTime');
        if ($this->checkout !== null || $dt !== null) {
            if ($this->checkout === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->checkout->format("Y-m-d H:i:s.u")) {
                $this->checkout = $dt === null ? null : clone $dt;
                $this->modifiedColumns[LabVisitTableMap::COL_CHECKOUT] = true;
            }
        } // if either are not null
    ...
    /**
     * Set the value of [courseid] column.
     *
     * @param int $v new value
     * @return $this|\LabVisit The current object (for fluent API support)
     */
    public function setCourseid($v)
    {
        ...
        if ($this->courseid !== $v) {
            $this->courseid = $v;
            $this->modifiedColumns[LabVisitTableMap::COL_COURSEID] = true;
        }
    ...
    {
        if ($this->aCourse !== null && $this->courseid !== $this->aCourse->getId()) {
            $this->aCourse = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildLabVisitQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see LabVisit::setDeleted()
     * @see LabVisit::isDeleted()
     */
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                LabVisitTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[LabVisitTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . LabVisitTableMap::COL_ID . ')');
        }
        ...
        if ($this->isColumnModified(LabVisitTableMap::COL_CHECKOUT)) {
            $modifiedColumns[':p' . $index++]  = 'checkout';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'checkin':
                        ...
                        break;
                    case 'checkout':
                        $stmt->bindValue($identifier, $this->checkout ? $this->checkout->format("Y-m-d H:i:s.u") : null, PDO::PARAM_STR);
                        break;
                    case 'courseid':
    ...
    {
        $pos = LabVisitTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['LabVisit'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['LabVisit'][$this->hashCode()] = true;
    ...
    {
        $criteria = new Criteria(LabVisitTableMap::DATABASE_NAME);
        ...
        if ($this->isColumnModified(LabVisitTableMap::COL_CHECKOUT)) {
            $criteria->add(LabVisitTableMap::COL_CHECKOUT, $this->checkout);
        }
        if ($this->isColumnModified(LabVisitTableMap::COL_COURSEID)) {
    ...
    {
        $criteria = ChildLabVisitQuery::create();
        $criteria->add(LabVisitTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \LabVisit (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \LabVisit Clone of current object.
     * @throws PropelException
     */
    ...
    {
        if ($this->aCourse === null && ($this->courseid != 0)) {
            $this->aCourse = ChildCourseQuery::create()->findPk($this->courseid, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCourse->addLabVisits($this);
             */
        }
